package reminder.daterange.br.unb.cic.reminders.model;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import reminder.daterange.util.Patterns;
import reminder.daterange.br.unb.cic.framework.persistence.DBTypes;
import reminder.daterange.br.unb.cic.framework.persistence.annotations.Column;
import reminder.daterange.br.unb.cic.framework.persistence.annotations.Entity;
import
reminder.daterange.br.unb.cic.framework.persistence.annotations.ForeignKey;
import reminder.daterange.br.unb.cic.reminders.view.InvalidHourException;
